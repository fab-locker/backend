...
// Créez une classe mock pour le repository
...
describe('LockersService', () => {
        ...
        const module: TestingModule = await Test.createTestingModule({
            providers: [
                LockersService,
                {
                    ...
                    useClass: LockerRepositoryMock, // Utilisez la classe mock pour le repository
                },
            ],
        }).compile();

        service = module.get<LockersService>(LockersService);
        repository = module.get<Repository<LockerEntity>>(getRepositoryToken(LockerEntity));
    });

    describe('findAll', () => {
        it('should return an array of lockers', async () => {
            jest.spyOn(repository, 'find').mockImplementation(() => Promise.resolve([]));
    ...
    describe('findOne', () => {
        it('should return a single locker by ID', async () => {
            ...
            jest.spyOn(repository, 'findOne').mockImplementation(() => Promise.resolve(mockLocker));
    ...
    describe('createLocker', () => {
        it('should create a new locker', async () => {
            ...
            jest.spyOn(repository, 'save').mockImplementation(() => Promise.resolve(newLockerData));
